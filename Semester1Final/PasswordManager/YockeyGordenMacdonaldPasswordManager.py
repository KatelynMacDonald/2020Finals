    ...
    if passWordUI!=password:
        ...
        while ui!="done":       #this keeps the program running until the user types done
            ...
            if ui==("home"):        #if the user wants to put passwords in the home section it will ask for what the password is for, the username,and the password and append that all to the home list
                ...
                while deleteUI!="n":
                    if deleteUI in homePasswords[0]:        #this will see if what they want to delete is in their home passwords
                        ind=homePasswords[0].index(deleteUI)        #it will see what index it is that they want to delete
                        del homePasswords[0][ind]                   #this will pull the same index from each list and delete it
                    ...
                    elif deleteUI in workPasswords[0]:  #this will see if what they want to delete is in their work passwords
                        ind=workPasswords[0].index(deleteUI)             #it will see what index it is that they want to delete
                        del workPasswords[0][ind]                #this will pull the same index from each list and delete it
                        del workPasswords[1][ind]
                        del workPasswords[2][ind]
                        print(f"Your {deleteUI} has been deleted along with its username and password\n")
                        
                    elif deleteUI in entertainmentPasswords[0]:         #this will see if what they want to delete is in their entertainment passwords
                        ind=entertainmentPasswords[0].index(deleteUI)            #it will see what index it is that they want to delete
                        del entertainmentPasswords[0][ind]               #this will pull the same index from each list and delete it
                        del entertainmentPasswords[1][ind]
                        del entertainmentPasswords[2][ind]
                        print(f"Your {deleteUI} has been deleted along with its username and password\n")
                        
                    elif deleteUI in billsPasswords[0]:         #this will see if what they want to delete is in their bills passwords
                        ind=billsPasswords[0].index(deleteUI)            #it will see what index it is that they want to delete
                        del billsPasswords[0][ind]                   #this will pull the same index from each list and delete it
                        del billsPasswords[1][ind]
                        del billsPasswords[2][ind]
                        print(f"Your {deleteUI} has been deleted along with its username and password\n")
                        
                    elif deleteUI in randomPasswords[0]:            #this will see if what they want to delete is in their random passwords
                        ind=randomPasswords[0].index(deleteUI)           #it will see what index it is that they want to delete
                        del randomPasswords[0][ind]                  #this will pull the same index from each list and delete it
                        del randomPasswords[1][ind]
                        del randomPasswords[2][ind]
                        print(f"Your {deleteUI} has been deleted along with its username and password\n")
                        
                    elif deleteUI in userCata[0]:               #this will see if what they want to delete is in the catagory that they made 
                        ind=userCata[0].index(deleteUI)          #it will see what index it is that they want to delete
                        del userCata[0][ind]                     #this will pull the same index from each list and delete it
                        del userCata[1][ind]    
                        del userCata[2][ind]
                        print(f"Your {deleteUI} has been deleted along with its username and password\n")
