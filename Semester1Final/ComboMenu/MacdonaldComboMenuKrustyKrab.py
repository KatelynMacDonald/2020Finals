...
def orderFunction(ui):
    ...
    while ui!="next":      #while the user input doesn't = next it will add the amount of money that the user choose and append what food they want to the order list
        if ui=="krabby patty":
                subtotal+=1.25
                yN=True
                ui=input("Would you like sea cheese on it? y or n\n ").lower()
                while (yN):
                    IC=YNInputCheck(ui)
                    #if "False" in str(IC):
            ...
            subtotal+=1.00
            sML=True
            ui=(input("What size would you like s,m,l? \n")).lower()
            while (sML):
                SC=SMLInputCheck(ui)
                if "Done" in str(SC):
                    break
            ...
            subtotal+=1.50
            yN=True
            ui=input("Would you like salty sauce? y or n\n ").lower()
            while (yN):
                    IC=YNInputCheck(ui)
                    #if "False" in str(IC):
            ...
            subtotal+=2.00
            yN=True
            ui=input("Would you like it with sauce? y or n\n ").lower()
            while (yN):
                    IC=YNInputCheck(ui)
                    #if "False" in str(IC):
            ...
            ui=input("What would you like to take out(if you don't want to take anything out type'n') \n").lower()
        ...
        ui=input("What would you like on this order(if you are done type 'next')(if you would like to change your order type'change') REMEMBER: You can only edit your meal while you are inside the order \n").lower()
...
ui=input("What would you like on this order(when you are done on this order type 'next' for a new one)(when you are done ordering type 'done') REMEMBER: You can only edit your meal while you are inside the order \n  ").lower()
